<div class="container my-4">
    <div class="nav nav-tabs justify-content-center admin-tabs-float" id="vetTabNav" role="tablist">
        <a href="{{ url('/veterinario#citas') }}" class="nav-link admin-btn-nav" id="btn-citas" role="tab">Citas</a>
        <a href="{{ url('/veterinario#historiales') }}" class="nav-link admin-btn-nav" id="btn-historiales" role="tab">Historiales</a>
        <a href="{{ url('/veterinario#mascotas') }}" class="nav-link admin-btn-nav" id="btn-mascotas" role="tab">Mascotas</a>
    </div>
    <script>
